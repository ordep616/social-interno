...
| OS-020 | Element Call embedded       | `https://github.com/element-hq/element-call`                       | pacote npm `@element-hq/element-call-embedded` `0.20.1`       | AGPL-3.0 ou licença comercial, a revisar                                   | Widget incorporado ao fork do Cinny para a POC de chamadas | Compartilhado | Dependência já presente no frontend; registro e revisão antes de liberar chamadas    |
| OS-021 | LiveKit Server              | `https://github.com/livekit/livekit`                               | imagem `livekit/livekit-server:v1.13.1`                      | Apache-2.0                                                                 | SFU WebRTC da POC local de chamadas MatrixRTC          | Colaborador 1 | Configuração local incorporada; execução e revisão antes de homologação              |
| OS-022 | MatrixRTC Authorization Service | `https://github.com/element-hq/lk-jwt-service`                  | imagem `ghcr.io/element-hq/lk-jwt-service:0.4.4`             | AGPL-3.0 ou licença comercial, a revisar                                   | Emissão de JWT LiveKit a partir de identidade Matrix   | Colaborador 1 | Configuração local incorporada; execução e revisão antes de homologação              |
| OS-023 | coturn                      | `https://github.com/coturn/coturn`                                 | imagem `coturn/coturn:4.12.0`                                | BSD-3-Clause AND MIT                                                       | TURN/STUN da POC local de chamadas                     | Colaborador 1 | Configuração local incorporada; IP público e endurecimento pendentes                 |
| OS-024 | Traefik                     | `https://github.com/traefik/traefik`                               | `v3.7.1` / `fa49e2b`                                         | MIT                                                                        | Proxy reverso e controles locais da borda              | Colaborador 1 | Aprovado pelos dois colaboradores; configuração local incorporada                    |
| OS-025 | mkcert                      | `https://github.com/FiloSottile/mkcert`                             | `v1.4.4` / `2a46726`                                         | BSD-3-Clause                                                               | CA e certificado descartáveis da homologação interna   | Colaborador 1 | Ferramenta operacional aprovada para a etapa interna; não instalada pelo projeto      |
