...
| AS-003 | Fundo da home provisório    | Arquivo fornecido pelo usuário em `photo_2026-07-21 16.32.47.jpeg` | JPEG 1280x853; copiado para `frontend/public/res/background` | Ativo próprio/provisório; direitos de uso a confirmar antes da homologação | Fundo visual da tela inicial do cliente web           | Colaborador 2 | Incorporado no frontend como ativo de identidade provisório                         |
